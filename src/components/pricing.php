            ...
            <div class="col-8 col-lg-4 col-xl-3">
                <div class="card border-0">
                    <div class="card-body text-center py-4">
                        ...
                        <p class="card-text mx-5 text-muted d-none d-lg-block">Begin your journey with 'Starter Edition.' Access essential features, kickstart your experience, and enjoy a budget-friendly introduction to excellence. Start now!</p>
            ...
            <div class="col-8 col-lg-4">
                <div class="card border-primary border-2">
                    ...
                    <div class="card-body text-center py-5">
                        ...
                        <p class="card-text mx-5 text-muted d-none d-lg-block">Exclusive bundle: 'Complete Edition'—ultimate value, premium features, unbeatable price. Elevate your experience with this limited-time offer. Grab yours now!</p>
                        <a href="#" class="btn btn-outline-primary btn-lg mt-3">
                            Buy Now
                        </a>
                    </div>
            ...
            <div class="col-8 col-lg-4 col-xl-3">
                <div class="card border-0">
                    <div class="card-body text-center py-4">
                        ...
                        <p class="lead card-subtitle">Attend to lessons in real life</p>
                        <p class="display-5 my-4 text-primary fw-bold">$23.99 <span class="small">/mo</span></p>
                        <p class="card-text mx-5 text-muted d-none d-lg-block">Unleash the extraordinary with 'Ultimate Edition.' Packed with exclusive content, cutting-edge features, and unmatched value. Upgrade your experience!</p>
                        <a href="#" class="btn btn-outline-primary btn-lg mt-3">
                            Buy Now
                        </a>
                    </div>
